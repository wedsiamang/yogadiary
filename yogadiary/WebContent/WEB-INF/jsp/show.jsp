...
<body>
	<div class="mx-auto" style="width:300px">
		<h1 class = "mb-3" style="text-align:center">UPDATE</h1>
	<form action="/yogadiary/UpdateServlet" method="post">
		<div class="mb-3">
		...
		<div class="mb-3">
			...
			<input type="date" class="form-control"  name="date" value="<%=day.getDate()%>">
		</div>
		<div class="mb-3">
			<label for="weather" class="form-label">weather</label>
			<select id="weather" name="weather" class="form-control">
				<option value="<%=day.getWeather()%>"><%=day.getWeather() %>️</option>
		...
		<div class="mb-3">
			...
			<select  name="covid19" class="form-control">
				<option value="<%=day.getCovid19() %>"><%=day.getCovid19() %></option>
		...
		<div class="mb-3">
			...
			<select name="BBT" class="form-control">
				<option value="<%=day.getBBT()%>"><%=day.getBBT() %></option>
		...
		<div class="mb-3">
			...
			<input type="time" name="time"value="<%=day.getTime() %>"></label>	
		</div>
	</div>
	<br>
	<div style="text-align:center;style="width:300px">
		<label for="series" class="form-label">*please recheck.</label><br>
			...
			<input type="radio"  name="series" value="halfprimary">half
			<input type="radio"  name="series"  value="fullprimary">full
			<input type="radio"  name="series" value="secondseries">second
	...
	<div class="mx-auto" style="width:300px">
		<div class="mb-3">
			...
			<select name="teacher" class="form-control">
				<option value="<%=day.getTeacher()%>"><%=day.getTeacher() %></option>
		...
		<div class="mb-3">
			...
			<input type="text" class="form-control"  name="condition" value="<%=day.getCondition()%>">
		</div>
		<br>
		<div class="mb-3">
		<label for="checkbox" class="form-label">*please recheck.</label><br>
		...
		<div class="mb-3">
			...
			<input type="text" class="form-control"  name="ate" value="<%=day.getAte()%>">
		</div>
		<div class="mb-3">
			<label for="event" class="form-label">event</label>
			<input type="text" class="form-control" name="event" value="<%=day.getEvent()%>">
		</div>
	</div>
